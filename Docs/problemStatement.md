...
*   **Refusal Style:** Polite and clearly worded.
*   **Reinforcement:** State the facts-only limitation.
*   **Education:** Provide a relevant educational link (e.g., AMFI or SEBI resource).
...
*   PAN or Aadhaar numbers, Account numbers, OTPs, Email addresses, or Phone numbers.
...
*   **README Document:** Setup instructions, selected AMC/schemes, Architecture overview (RAG approach), and known limitations.
